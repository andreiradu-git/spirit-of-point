...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Point Studio — Best Professional Photography Studio in Bucharest",
      },
      {
          ...
          <div className="absolute inset-0 z-10 pointer-events-none">
            <div className="mx-auto max-w-7xl h-full px-3 sm:px-6 pt-[max(4.5rem,7cqw)] sm:pt-[max(5.5rem,9cqw)] md:pt-[max(6rem,9cqw)] pb-[2cqw] sm:pb-[3cqw] flex flex-col justify-between">
              <div className="max-w-[70%] sm:max-w-[65%] md:max-w-[60%] text-white pointer-events-auto">
                ...
                >
                  We blend creativity with technical expertise and a deep commitment to quality and
                  thats how we transform your ideas into stunning visuals that captivate and sell.
                </Editable>
                <Editable
                  as="p"
                  id="hero.cta"
              ...
              <div className="flex gap-[3cqw] text-white">
                <div>
                  <Editable
                    as="div"
                    id="hero.stat1.value"
                    className="font-sans font-bold leading-none text-[clamp(0.9rem,2.6cqw,2.5rem)]"
                  >
                    10+
                  </Editable>
                  <Editable
                    ...
                    id="hero.stat1.label"
                    multiline
                    className="uppercase tracking-widest text-white/70 mt-[0.5cqw] text-[clamp(0.45rem,0.85cqw,0.75rem)] whitespace-pre-line"
                  >
                    {"Years of\nexpertise"}
                  </Editable>
                </div>
                ...
                >
                  <div className="flex items-center gap-[0.6cqw]">
                    <svg
                      viewBox="0 0 48 48"
                      className="w-[clamp(0.9rem,2.4cqw,2rem)] h-[clamp(0.9rem,2.4cqw,2rem)]"
                      aria-hidden="true"
                    >
                      <path
                        fill="#FFC107"
                        d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34 6.5 29.3 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5 43.5 34.8 43.5 24c0-1.2-.1-2.4-.4-3.5z"
                      />
                      <path
                        fill="#FF3D00"
                      ...
                      <path
                        fill="#4CAF50"
                        d="M24 43.5c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.4-4.5 2.2-7.2 2.2-5.2 0-9.6-3.3-11.3-7.9l-6.5 5C9.6 39 16.2 43.5 24 43.5z"
                      />
                      <path
                        fill="#1976D2"
                    ...
                    <div>
                      <div className="flex gap-[0.2cqw]">
                        {[0, 1, 2, 3, 4].map((i) => (
                          <Star
                            key={i}
                            className="w-[clamp(0.4rem,1cqw,0.9rem)] h-[clamp(0.4rem,1cqw,0.9rem)] fill-yellow-400 stroke-yellow-400"
                          />
                        ))}
                      </div>
          ...
          <div className="grid md:grid-cols-12 gap-10 items-end mb-14">
            <div className="md:col-span-5">
              <Editable
                as="div"
                id="studio.eyebrow"
                className="text-xs uppercase tracking-[0.3em] text-muted-foreground mb-3 block"
              >
                01 — Point Studio
              </Editable>
              <Editable
                as="h2"
                id="studio.title"
                className="font-serif italic text-5xl md:text-6xl lg:text-7xl leading-[1] text-foreground block"
              >
                The Studio
              </Editable>
            </div>
            <div className="md:col-span-7 text-[15px] md:text-base leading-relaxed text-foreground/80">
              <Editable as="p" id="studio.intro" multiline>
                Managed by Andrei C. Radu, a graduate in Photo-Video class of the National Arts
                University, Point Studio is a professional photography studio & creative work space
                located in Bucharest, being part of Atelierele Scanteia — a creative hub of artist
                workspaces and galleries in the former communist "Casa Scanteii", in the present
                House of Free Press.
              </Editable>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mt-14 grid md:grid-cols-2 gap-10 text-[15px] md:text-base leading-relaxed text-foreground/80">
            <Editable as="p" id="studio.body1" multiline>
              Point Studio is a 200 square meters professional photo-video studio and creative work
              space created as part of Atelierele Scanteia. The space provides professional photo
              setups, equipment and specialists to accommodate all photography briefs. It has
              accessible parking, Wi-fi access and comfortable working space, which allows our
              clients to be present for the entire photo session, without missing out on their day
              at work.
            </Editable>
            <Editable as="p" id="studio.body2" multiline>
              The fully equipped kitchen and the extensive prop room located on-site, coupled with
              long lasting relations with food stylists, prop researchers, hair stylists, makeup
              specialists and other collaborators, assure a great work experience.
            </Editable>
          </div>
        </div>
      </section>
